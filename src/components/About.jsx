function About() {
  return (
    <section
      id="about"
      className="bg-gray-900 text-gray-300 py-20 px-6 md:px-16 flex flex-col items-center text-center"
    >
      ...
      <p className="max-w-3xl text-lg leading-relaxed mb-10">
        I'm <span className="text-white font-semibold">Khaled</span>, a passionate
        <span className="text-indigo-400 font-medium"> Full Stack Developer </span>
        and <span className="text-indigo-400 font-medium">Graphic Designer</span> with over
        <span className="text-white font-medium"> 8 years of experience</span> crafting elegant, scalable web applications and powerful visual identities.
        <br />
        <br />
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl">
        <div className="bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-indigo-500/30 transition">
